"""
Manual quality assessment for Agent 1 on ~100k token context.
"""
...
def manual_quality_check_100k():
    """
    Run Agent 1 on ~100k token context (messages 1-5).
    """
    print("=== AGENT 1 QUALITY CHECK (~100k tokens) ===\n")
